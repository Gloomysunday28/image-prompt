...
| 治愈 | [prompt-one.md](治愈/prompt-one.md) | 9:16 | 中 | 滑板少年冲下海岸公路的夏日治愈画面 |
| 宫崎骏画风 | [prompt-one.md](宫崎骏画风/prompt-one.md) | 不限 | 短 | 阿马尔菲海岸复古旅行海报插画 |
...
- [`prompt-one.md`](宏大风格/prompt-one.md)：单张成图用。40–50mm 平视、人眼高度 1.4 米，明确写死「不航拍」。
...
[`prompt-one.md`](治愈/prompt-one.md)：9:16 竖版，日系动画背景美术 × 高质量 3D CGI 写实质感。14mm 超广角低机位跟拍，少年踩滑板沿陡坡公路冲向海岸，人物刻意画小以突出世界尺度，公路的黄色中心线充当视觉引导线。

### 宫崎骏画风 · 复古旅行海报

[`prompt-one.md`](宫崎骏画风/prompt-one.md)：现代铅笔插画 + 1950–60 年代旅行海报风。阿马尔菲海岸悬崖公路、白色老爷车、地中海帆船、前景柠檬枝框景，丝网印刷质感与松散笔触。整条提示词只有一段，适合当作短提示词的写法参考。
...
| 预览 | 作品 | 画面要点 |
| :---: | --- | --- |
| <img src="梦幻空灵/童话.png" width="320" /> | **梦幻空灵 · 童话**<br />[`梦幻空灵/童话.md`](梦幻空灵/童话.md) | 第三人称跟拍少女趟过浅水，人物压在左侧三分线上、体型不大；七彩天河以 S 形横贯粉紫色天空，落日压在远处地平线；脚下浅水完整倒映天色，雪山、松林与花海负责把超现实天空拉回「可信的真实世界」。 |
| <img src="武侠/机甲-白天.png" width="320" /> | **武侠 · 机甲（白天）**<br />[`武侠/机甲-白天.md`](武侠/机甲-白天.md) | 未来东方剑圣悬浮在真实现代超级都市上空，白天自然光。铠甲、头盔、流马尾、披风逐节写死，城市必须符合现实工程逻辑。 |
| <img src="武侠/机甲-夜晚.png" width="320" /> | **武侠 · 机甲（夜晚）**<br />[`武侠/机甲-夜晚.md`](武侠/机甲-夜晚.md) | 与白天版共用同一套角色设定，只更换时间与天气——暴雨夜战，城市灯光成为主光源。控制单一变量做系列图的范例。 |
